  ...
  return (
    <Container>
      <Row>
        ...
        <Col className="social" xs="12" sm="12" md="6" lg="6" xl="6">
          <h6 className="social">
          <hr></hr>
            101 Cookbooks is a California food blog by Heidi Swanson, focused on
            healthy recipes for everyday. It features over 700 vegetarian
